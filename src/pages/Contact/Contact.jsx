  ...
  return (
    ...
    >
      <div>
        ...
        <p className=" text-[#6f6b80] text-xl">
        ...
        <div className="flex gap-4 mt-8">
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            ...
            {/* Step 2: Wrap each Link with motion.div */}
            <Link
              to="https://web.facebook.com/profile.php?id=100009220888010"
              target="_blank"
            >
          ...
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            ...
            <Link
              to="https://www.linkedin.com/in/mostafizur-rahman-a62927277/"
              target="_blank"
            >
          ...
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            ...
            {/* Wrap with motion.div */}
            <Link
              to="https://www.instagram.com/mdmostafizur64/"
              target="_blank"
            >
      ...
      <div>
        ...
        <div>
          <h2 className="text-3xl font-bold text-[#15295f]">
            ...
            <div className="card space-y-8 mt-4">
              ...
              <div className="mt-6">
                <input
                  type="submit"
                  value="Send Message"
                  className=" btn btn-outline rounded-full hover:text-orange-500 hover:bg-white hover:border-orange-400 border-2 bg-orange-500  px-8 text-white  "
                />
              </div>
            </div>
