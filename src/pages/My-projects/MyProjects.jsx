  ...
  const data = [
    {
      ...
      image:
        "https://img.freepik.com/free-vector/web-design-agency-landing-page_52683-868.jpg?w=740&t=st=1688285606~exp=1688286206~hmac=a7f5fa75886f74148e41b70bd399b62735877a28e8f8ef3065214aee0ae17a9c",
    },
    {
      name: "Animal Toys",
      live_link: "https://animal-toys-project-4905d.web.app/",
      image:
        "https://img.freepik.com/premium-vector/add-cart-illustration-web-page_1124-694.jpg?w=740",
    },
    {
      name: "Chef Recipe",
      live_link: "https://the-chef-project-2637f.web.app/",
      image:
        "https://img.freepik.com/free-vector/app-development-landing-page_52683-871.jpg?w=740&t=st=1688285640~exp=1688286240~hmac=c21a5e98c03b6b0cdb1cc68c1186830685e89da068aaf114327bc9a1316afeea",
    },
  ];

  return (
    <div id="myProjects" className=" mt-8">
      <Container>
